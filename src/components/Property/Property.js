            ...
            <div className="upload-form_container">
                ...
                <div className="right">
                         <form action="/property" method="POST" enctype="multipart/form-data" className="upload-property-form">
                            <label>
                             Property Name
                                <input type="text" name="name" placeholder="Enter the name of the property" onChange={handleChange}/>
                            </label>
                            <label>
                             Property Type
                                <input type="text" name="type" placeholder="Hotel/Apartment/Cabin/Others" onChange={handleChange}/>
                            </label>
                            <label>
                              Location
                                <input type="text" name="location" placeholder="Location of the Property" onChange={handleChange}/>
                            </label>
                            <label>
                              Address
                            ...
                            <label>
                               Features
                                 <input type="text" name="keyword" placeholder="Enter main features" onChange={handleChange}/>
                            </label>

                            <label>
                               Upload Images
                                  <input id="images" type="file" multiple name="images" onChange={uploadImage} />
                            </label>
